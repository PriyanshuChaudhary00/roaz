        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="flex items-start gap-3 pt-1">
              <input id="signup-terms" type="checkbox" required className="mt-0.5 accent-foreground" />
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-xs font-medium text-foreground/30 text-center">or join with</span>
            <div className="flex-1 h-px bg-foreground/10" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-10">
            {["Google", "Apple"].map((provider) => (
              <button
                ...
                className="py-3 border border-foreground/15 rounded-xl text-sm font-semibold hover:bg-foreground/5 transition-colors flex items-center justify-center gap-2"
              >
                {provider === "Google" ? (
