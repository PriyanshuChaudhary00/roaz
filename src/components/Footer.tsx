...
export const Footer = () => {
  return (
    <footer className="py-32 px-8 bg-zinc-950 text-white rounded-t-[100px] mt-24">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="flex flex-col gap-6">
            <h2 className="text-4xl font-black tracking-widest mb-4">ROAZ</h2>
            <p className="text-zinc-500 font-medium max-w-xs leading-8">
            ...
            <div className="flex items-center gap-6">
              <Link href="#" className="p-3 bg-white/5 hover:bg-white/10 rounded-full transition-colors group">
          ...
          <div className="flex flex-col gap-8">
            <h3 className="text-lg font-bold tracking-widest uppercase text-white/40">Quick Links</h3>
          ...
          <div className="flex flex-col gap-8 lg:col-span-2">
            <h3 className="text-lg font-bold tracking-widest uppercase text-white/40">Keep Up With ROAZ</h3>
            <p className="text-zinc-500 font-medium text-lg mb-4">Subscribe to our newsletter for exclusive drops and limited collection updates.</p>
            <form className="relative flex items-center">
              <input 
                type="email" 
                placeholder="YOUR EMAIL ADDRESS" 
                className="w-full bg-transparent border-b-2 border-white/10 pb-4 text-2xl font-black focus:outline-none focus:border-white transition-colors"
              />
        ...
        <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 text-zinc-600 font-medium">
